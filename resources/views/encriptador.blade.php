...
@section('title', 'Neubox Test - Encriptador')
@section('content')    
    <a href="{{ route('home') }}" class="btn btn-block btn-outline-secondary mb-3"><i class="fas fa-long-arrow-alt-left"></i> Regresar</a>
    <h3 class="d-block w-100 text-center mb-4">Encriptador</h3>
    <form id="formEncriptador">        
        ...
        <div class="form-group">
            ...
            <input type="submit" class="form-control btn btn-primary" value="Aceptar">
